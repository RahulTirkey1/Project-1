...
@DataMongoTest        //Benefit of this is that it doesn't load all of the spring context only loads up Mongo context.
...
public class ItemReactiveRepositorytest 
{
	    ...
	    public void setUp() {
	        itemReactiveRepository.deleteAll()
	                ...
	                .blockLast();  //It is only to be used in test cases, and it basically ensures all the documents are loaded.
	    }
	    ...
	    public void findItemByDescription() {
	        ...
	        //Like in SQL where we have LIKE operator matching a single alphabet or word, Here the document needs to be matched exactly.
	    }
	    @Test
